...
- 2026-07-15: la bandeja de Notificaciones consulta únicamente hoy y ayer mediante `GET /api/notifications?desde=`, muestra inicialmente 5 avisos y revela bloques adicionales de 5 con `Mostrar más`.
