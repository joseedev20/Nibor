...
- [ ] 2026-07-15 Vehículos: agregar Tarjeta de propiedad a vehículos existentes/nuevos y una sección de Licencia de conducción con PDF único, categorías dinámicas y vencimiento independiente por categoría; actualizar D1, API, UI, notificaciones, smoke y producción.
