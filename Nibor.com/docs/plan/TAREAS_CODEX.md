...
- [ ] 2026-07-13 Eventos móvil real: proteger el feed ICS con token secreto rotatorio, entregar la URL desde la sesión autenticada, configurar bypass exacto en Access, desplegar y verificar suscripción desde celular.
