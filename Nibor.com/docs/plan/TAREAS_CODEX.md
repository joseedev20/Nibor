...
- [x] 2026-07-15 Notificaciones: limitar la bandeja a hoy y ayer, mostrar inicialmente las 5 más recientes y revelar bloques de 5 con `Mostrar más`. API, test, build y smoke aislado OK.
