...
function emptySettings() {
  return {
    ...
    recordatorios_repetir_minutos: '240',
...
function normalizeSettings(data = {}) {
  return {
    ...
    recordatorios_repetir_minutos: ['5', '10', '15', '60', '120', '180', '240', '360', '480', '720', '1440'].includes(String(data.recordatorios_repetir_minutos)) ? String(data.recordatorios_repetir_minutos) : '240',
...
function settingsPayload() {
  return {
    ...
    recordatorios_repetir_minutos: String(settings.value.recordatorios_repetir_minutos),
        ...
        <article class="rounded-lg border border-zinc-200 p-4 dark:border-zinc-800">
          ...
          <div class="mt-3 grid gap-3">
            ...
            <label class="grid gap-1 text-sm">
              ...
              <select v-model="settings.recordatorios_repetir_minutos" class="h-10 rounded-lg border border-zinc-200 bg-white px-3 outline-none focus:border-emerald-500 dark:border-zinc-700 dark:bg-zinc-950">
